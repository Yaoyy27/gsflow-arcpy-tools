#--------------------------------
# Name:         gsflow_crt_cascade_parameters.py
# Purpose:      GSFLOW CRT cascade parameters
...
def gsflow_crt_cascade_parameters(workspace, config_path=None):
    """Calculate GSFLOW CRT Cascade Parameters
    ...
    try:
        ...
        ## Parameters
##        lake_seg_offset = config.getint('INPUTS', 'lake_seg_offset')
##        exit_seg = 0
...
##                raise SystemExit()
        ...
        crt_ws = os.path.join(hru.param_ws, crt_ws_name)
...
##            hru.col_field, hru.row_field, hru.fid_field]
...
##            try: outseg = cell_dict[out_cell][1]
##            except KeyError: outseg = exit_seg
...
if __name__ == '__main__':
    ...
    ## Calculate CRT Cascade Parameters
    gsflow_crt_cascade_parameters(workspace, ini_path)
